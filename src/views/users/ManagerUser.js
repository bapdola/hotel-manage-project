...
import { 
    ...
    CCardText,CCardTitle,CCardBody,CCardImage,CCard,CCardLink,CListGroupItem,CListGroup,CTooltip
  ...
  <CTableBody>
    <CTableRow color="secondary">
      ...
      <CTableDataCell>
          ...
          placement="top"
        >
          <CButton color="info" shape="rounded-pill" variant="outline">Check in</CButton>
        </CTooltip>
            </>
      </CTableDataCell>
      <CTableDataCell>
    ...
    <CTableRow color="info">
      ...
      <>
          ...
          placement="top"
        >
          <CButton color="success" shape="rounded-pill" >Check out</CButton>
        </CTooltip>
            </>
      </CTableDataCell>
      <CTableDataCell>
      ...
      <Popup/>
        <>
          <CButton color="dark" onClick={() => setVisible(!visible)}>Delete</CButton>
          <CModal visible={visible} onClose={() => setVisible(false)}>
            <CModalHeader>
              <CModalTitle>Delete User</CModalTitle> 
            </CModalHeader>
            <CModalBody>
            Delete user : Vmax martis
            </CModalBody>
            <CModalFooter>
